...
/**
 * Servlet implementation class WebHelloWorld1Servlet
 */
@WebServlet("/WebHelloWorld1Servlet")
public class WebHelloWorld1Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * Default constructor. 
     */
    public WebHelloWorld1Servlet() {
